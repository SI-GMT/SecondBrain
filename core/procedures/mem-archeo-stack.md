...
Self-hosted Supabase signal: `docker-compose.yml` with `supabase/`, `kong:`, `postgrest:`, `gotrue:` services → tag specifically (common stack for self-hosted BaaS deployments).
