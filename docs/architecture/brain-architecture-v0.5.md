...
Scénario : `/mem-archeo /path/to/some-repo` traite le commit `fix(security): prevent force-push on main`. Le router produit 2 atomes.

**Atome 1 — archive du commit** (`10-episodes/projects/myapp/archives/2026-01-15-14h30-myapp-archeo-tag-v0-3-1.md`) :
...
3. **Test dry-run sur un vault de référence local** — pas d'écriture, juste le plan. Validation manuelle du plan.
